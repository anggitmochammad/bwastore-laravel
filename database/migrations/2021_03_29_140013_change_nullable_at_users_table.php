...
class ChangeNullableAtUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('anddress_one')->nullable()->change();
            $table->longText('anddress_two')->nullable()->change();
            $table->integer('provinces_id')->nullable()->change();
            $table->integer('refencies_id')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            // nullable kosong / default bernilai true
            $table->longText('anddress_one')->nullable(false)->change();
            $table->longText('anddress_two')->nullable(false)->change();
            $table->integer('provinces_id')->nullable(false)->change();
            $table->integer('refencies_id')->nullable(false)->change();
