...
<div class="page-content page-details">
    ...
    <div class="container">
        <div class="row">
        <!-- thumbnail besar kiri -->
        <div class="col-lg-8" data-aos="zoom-in">
            <transition name="slide-fade" mode="out-in">
            <!-- v-bind:src  v-bind:key -->
            <img
        ...
        <!-- thumbnail kecil kanan -->
        <div class="col-lg-2">
            <div class="row">
            <!-- fungsi v-for untuk looping dalam vue -->
            <div
