        ...
        >
            <a href="{{route('detail',$product->slug)}}" class="component-products d-block">
                <div class="products-thumbnail">
                    ...
                    {{-- pengecekan ini berfungsi untuk jika terdapat dua foto dalam satu product maka pilih foto yang pertama jika tidak ada foto sama sekali malah akan diarahkan ke default--}}
                    style="              
                    /* mengecek menggunakan relasi*/
                        @if($product->galleries->count())
                    /* dari product lalu relasi galleries lalu ambil yang pertama lalu ambil kolom foto*/
